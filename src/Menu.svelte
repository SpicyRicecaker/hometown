...
<div class="settings" style="transform: translate3d({-offsetReadWidth}px, 0, 0);" bind:this={settings}>
    <div class="menu" bind:offsetWidth={offsetWidth}>
  ...
  <div class="toggle" on:click={() => {changeSettings()}}>
    <div class="gear">
      &#9776;
    </div>
  </div>
